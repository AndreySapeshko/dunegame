...
public class ParticleController extends ObjectPool<Particle> {
    ...
    public ParticleController() {
        oneParticle = Assets.getOurInstance().getTextureAtlas().findRegion("star16");
    }
    ...
    public void render(SpriteBatch batch) {
        ...
        for (int i = 0; i < activeList.size(); i++) {
            ...
            batch.draw(oneParticle, o.getPosition().x - 8, o.getPosition().y - 8, 8, 8, 16, 16, scale, scale, 0.0f);
        }
